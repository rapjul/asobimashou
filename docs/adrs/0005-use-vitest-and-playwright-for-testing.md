...
- Good, because V8 coverage includes runtime TypeScript under `src/`, including application startup and UI modules; Playwright separately verifies browser behavior across engines.

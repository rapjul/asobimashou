...
main() {
	...
	mkdir -p public/assets/images/icons public/assets/images
	...
	# 4. Sync every static PWA and social image to Vite's public output.
	cp favicon.svg public/favicon.svg
	cp apple-touch-icon.png public/apple-touch-icon.png
	cp assets/images/icons/icon-192.png public/assets/images/icons/icon-192.png
	cp assets/images/icons/icon-512.png public/assets/images/icons/icon-512.png
	cp assets/images/preview.png public/assets/images/preview.png
	cp assets/images/thumbnail.png public/assets/images/thumbnail.png
	echo "✓ Synced manifest and social preview assets to public/"
